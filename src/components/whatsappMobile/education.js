    ...
    render() { 
        return ( 
            <div style={{display:"flex",flexDirection:"column",height:"100%"}}>
                <div id="edusChatWindow" style={{width:"96%",margin:"2%",paddingBottom:"20px",paddingTop:"20px"}}>
                    {
                                ...
                                this.props.msgs.map(msg => {
                                    return <div style={{display:"flex",flexDirection:"row",width:"90%",marginBottom:"10px",float:"right",justifyContent:"end"}}>
                                        <div style={{backgroundColor:"#272d30",borderRadius:"7px",padding:"5px",position:"relative",right:"-15px",top:"14px",borderTopRightRadius:"0px"}}>
                                            ...
                                            <div style={{float:"right",color:"#b1b3b5",fontSize:"13px"}}>{msg[1]}  
                                                <span><DoneIcon style={{fontSize:"10px",paddingLeft:"2px",marginBottom:"-2px"}}/></span>
                                            </div>
                                        </div>
                            ...
                            <div style={{display:"flex",flexDirection:"row",width:"90%",marginBottom:"50px"}}>
                                ...
                                <div style={{backgroundColor:"#056063",borderRadius:"5px",padding:"8px",position:"relative",left:"-10px",top:"10px",borderTopLeftRadius:"0px"}}>
                                    <div>
                                        ...
                                        <div style={{ fontSize:"13px",fontWeight:"600",padding:"2px",paddingLeft:"15px",paddingRight:"15px",borderRadius:"10px",background:"#b1b3b5",color:"black",width:"fit-content",marginBottom:"5px",marginTop:"10px"}}>{item.degree}</div>
                                        {
                                            item.content.map(ci => {
