...
class Skill extends Component {
    ...
    componentDidMount() {
        document.getElementById('skillsChatWindow').scrollIntoView({ behavior: 'auto', block: 'end' });
    }
    ...
    render() { 
        return ( 
            <div style={{display:"flex",flexDirection:"column",height:"100%"}}>
                <div id="skillsChatWindow" style={{width:"96%",margin:"2%",paddingBottom:"20px",paddingTop:"20px"}}>
                    {
