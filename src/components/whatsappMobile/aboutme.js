    ...
    render() { 
        return ( 
            <div style={{display:"flex",flexDirection:"column",height:"100%",width:"100%",alignItems:"center"}}>
                <div style={{margin:"5%",}}>
                    <iframe width="100%" src="https://www.youtube-nocookie.com/embed/Nq8GTPavdm0?controls=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
                ...
                <div style={{marginLeft:"5%",marginRight:"5%"}}>
                    <a style={{marginRight:"10px"}} href="https://drive.google.com/uc?id=1Vq-NLHgCend0CkAUP33XgwK0cYZ_Zgu0&export=download">
                        <div className="resume-buttom" style={{marginTop:"20px",marginBottom:"30px"}} >Download CV</div>
                    </a>
                    <a href="https://drive.google.com/file/d/1Vq-NLHgCend0CkAUP33XgwK0cYZ_Zgu0/view?usp=sharing" target="_blank" rel="noopener noreferrer">
                        <div className="resume-buttom" style={{marginTop:"20px",marginBottom:"30px"}} >View CV</div>
                    </a>
                </div>
            </div>
        );
