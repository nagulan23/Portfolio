...
class Contact extends Component {
    ...
    componentDidMount() {
        document.getElementById('contactsChatWindow').scrollIntoView({ behavior: 'auto', block: 'end' });
    }
    ...
    render() { 
        return ( 
            <div style={{display:"flex",flexDirection:"column",height:"100%"}}>
                <div id="contactsChatWindow" style={{width:"90%",margin:"5%",paddingBottom:"20px"}}>
                    {
                            ...
                            <div style={{display:"flex",flexDirection:"row",width:"75%",marginBottom:"50px"}}>
                                ...
                                <div style={{backgroundColor:"#056063",borderRadius:"5px",padding:"10px",position:"relative",left:"-10px",top:"10px",borderTopLeftRadius:"0px"}}>
                                    <div>
                                        ...
                                        {
                                            item.content.map(ci => {
                                                return <div style={{color:"#b1b3b5", fontSize:"18px",fontWeight:"600",padding:"0px"}}>{ci}</div>
                                            })
                                        }
